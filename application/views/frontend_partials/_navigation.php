            ...
            <ul class="navbar-nav ml-auto">
                ...
                if($login == TRUE){ ?>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <?php if ($this->session->userdata('admin_status')=='Administrator'): ?>
                                <a class="dropdown-item" href="<?php echo base_url('admin'); ?>">Data Admin</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="<?php echo base_url('kecamatan'); ?>">Data Wilayah</a>

                            <?php endif ?>
                            <a class="dropdown-item" href="<?php echo base_url('lahan'); ?>">Lokasi Lahan</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <?php echo $this->session->userdata('admin_namalengkap'); ?>
                        </a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <?php
                      ...
                      <a href="<?php echo base_url('login'); ?>" class="btn btn-warning btn-sm <?php if($this->uri->segment(4) == 'login'){ echo 'active';} ?>"> Masuk</a>
                    <?php
                }
                ?>
            </ul>
