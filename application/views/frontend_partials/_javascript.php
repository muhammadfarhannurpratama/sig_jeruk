...
<script type="text/javascript" src="<?php echo base_url('assets/public/libs/bootstrap-4/js/bootstrap.min.js'); ?>">
</script>
<script type="text/javascript" src="<?php echo base_url('assets/public/libs/fancybox/jquery.fancybox.min.js'); ?>">
</script>
<script type="text/javascript" src="<?php echo base_url('assets/public/libs/tinymce/jquery.tinymce.min.js'); ?>">
</script>
...
<script type="text/javascript" src="<?php echo base_url('assets/public/libs/DataTables/datatables.min.js'); ?>">
</script>
