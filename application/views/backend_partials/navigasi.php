        ...
        <div class="main_container">
            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    ...
                    $img=$this->db->get('tb_admin')->row();
                    ?>

                    <!-- menu prile quick info -->
                    <div class="profile">
                        <div class="profile_pic">
                            <img src="<?php echo base_url('assets/img/fotouser/'.$img->foto_user);?>" alt="..." class="img-circle profile_img">
                        </div>
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        ...
                        <div class="menu_section">
                            ...
                            <li><a><i class="fa fa-users"></i> Akun <span class="fa fa-chevron-down"></span></a>
                                        ...
                                        <?php endif ?>
                                        <li><a><i class="fa fa-tags"></i> Kelola Data <span class="fa fa-chevron-down"></span></a>
                                            <ul class="nav child_menu" style="display: none">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                    <img src="<?php echo base_url();?>assets/img/user/User.png" alt=""> <span class=" fa fa-angle-down"> </span>
                                </a>
