                                ...
                                <div class="card-header">
                                    <ul class="nav nav-tabs card-header-tabs">
                                        <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link bg-orange active " id="5b" data-toggle="pill"
                                                    href="#custom-tabs-four-home" role="tab"
                                                    aria-controls="custom-tabs-four-home" aria-selected="true">Pesanan
                                                    Masuk</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link bg-purple" id="custom-tabs-four-profile-tab"
                                                    data-toggle="pill" href="#custom-tabs-four-profile" role="tab"
                                                    aria-controls="custom-tabs-four-profile"
                                                    aria-selected="false">Dikemas</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link bg-blue" id="custom-tabs-four-messages-tab"
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link bg-green" id="custom-tabs-four-settings-tab"
                                            ...
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <b>Rp.<?= number_format($value->total_bayar,0 )?></b> <br>
                                                        <b> <span
                                                                class="badge badge-primary">Dikemas/Diproses</span></b>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <table class="table">
                                            ...
                                            <tr>
                                                <th>No. Resi</th>
                                                <th>:</th>
                                                <th><input name="no_resi" class="form-control" placeholder="No. Resi"
                                                        required></th>
                                            </tr>
