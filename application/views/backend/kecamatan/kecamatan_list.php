                                ...
                                <div class="x_content">
                                    <div class="row" style="margin-bottom: 10px">
                                        ...
                                        <div class="col-md-6 text-right">
                                            <?php echo anchor(site_url('Kecamatan/create'), '<i class="fa fa-plus-square"> </i> Tambah Kecamatan', 'class="btn btn-primary"'); ?>
                                        </div>
                                    </div>
                                    <table class="table table-bordered table-striped" id="mytable">
                                        ...
                                        foreach ($kecamatan_data as $kecamatan)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <?php 
                                                echo anchor(site_url('Kecamatan/update/'.$kecamatan->kecamatan_id),'<i class="fa fa-edit"></i> Update', 'class="btn btn-warning btn-xs"'); 
