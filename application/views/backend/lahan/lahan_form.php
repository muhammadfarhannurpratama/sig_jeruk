                                        ...
                                        <form action="<?php echo $action; ?>" method="post"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="nama_pemilik"
                                                    id="nama_pemilik" placeholder="Pemilik Lahan"
                                            ...
                                            <div class="form-group">
                                                <label
                                                    for="varchar">Jalan<?php echo form_error('lokasi_lahan') ?></label>
                                                <input type="text" class="form-control" name="lokasi_lahan"
                                                    id="lokasi_lahan" placeholder="Lokasi Lahan"
                                                    value="<?php echo $lokasi_lahan; ?>" />
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" name="harga_jeruk"
                                                    id="harga_jeruk" placeholder="Harga Jeruk"
                                                    value="<?php echo $harga_jeruk; ?>" />
                                            </div>
