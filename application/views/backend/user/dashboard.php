                    ...
                    <div class="row top_tiles">
                        ...
                        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="tile-stats">
                                ...
                                <?php if ($this->session->userdata('admin_status')=='Administrator'): ?>
                                    <a href="<?= base_url('Kecamatan') ?>"><p>Terdaftar di Sistem</p></a>
                                <?php else: ?>
                                    <a href="#"><p>Terdaftar di Sistem</p></a>
                                <?php endif ?>
                            </div>
                        </div>
                        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="tile-stats">
                                ...
                                <?php if ($this->session->userdata('admin_status')=='Administrator'): ?>
                                    <a href="<?= base_url('Kelurahan') ?>"><p>Terdaftar di Sistem</p></a>
                                <?php else: ?>
                                    <a href="#"><p>Terdaftar di Sistem</p></a>
                                <?php endif ?>
                            </div>
                        ...
                        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="tile-stats">
                                ...
                                <h3>Data Lahan</h3>
                                <a href="<?php echo base_url('Lahan') ?>"> <p>Terdaftar di Sistem</p> </a>
                            </div>
                        </div>
                        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="tile-stats">
                                ...
                                <h3>Data Jeruk</h3>
                                <?php if ($this->session->userdata('admin_status')=='Administrator'): ?>
                                    <a href="<?= base_url('Jeruk') ?>"><p>Terdaftar di Sistem</p></a>
                                <?php else: ?>
                                    <a href="#"><p>Terdaftar di Sistem</p></a>
                                <?php endif ?>
                            </div>
