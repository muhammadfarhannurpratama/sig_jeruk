                    ...
                    <div class="tab-pane fade show active" id="custom-tabs-four-home" role="tabpanel"
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($value->status_bayar == 0) { ?>
                                    <a href="<?= base_url('pesanan_saya/bayar/'.$value->kode_transaksipengguna) ?>"
                                ...
                                <td>
                                    <h5><?= $value->no_resi ?><br>
                                        <button data-toggle="modal"
                                            data-target="#diterima<?= $value->kode_transaksipengguna ?>"
...
<div class="modal fade" id="diterima<?= $value->kode_transaksipengguna ?>">
