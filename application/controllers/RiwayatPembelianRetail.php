    ...
    public function simpan_pesanan_retail($kode)
    {
        ...
        foreach ($sql->result() as $d) {
            ...
            if ($cek->num_rows() == 1) {
                ...
                $sql1= $this->db->query("UPDATE tb_retail SET stok=stok+'$d->qty' , id_jeruk='$d->id_jeruk',
                berat=1, harga_jual='$d->harga_jual', harga_beli='$d->harga' WHERE id_retail='$d->id_retail'");
            }
