...
class M_pencarian extends CI_Model
{
    public function __construct()
    {
        ...
        $this->fillable = ['nama_pemilik', 'lokasi_lahan', 'no_hp', 'ketinggian', 'suhu', 'hujan', 'tanah'];
    ...
    {
        $this->db->select("id_jeruk, jeruk_nama, minimum, maksimum");
        $this->db->from("rules");
        $this->db->join("tb_jeruk","tb_jeruk.id_jeruk=rules.hasil","left");
