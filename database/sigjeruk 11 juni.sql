...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 12, 2022 at 12:16 AM
...
(24, 'puput', 'babatan', '098765432167', '1646880981.png', 8, '1000', 100, '5000', '-8.192146', '113.440612', 28, 27, 0, '2022-05-01'),
(25, 'sukiman', 'jl. pucukan', '098123786546', '1647096092.PNG', 14, '500', 200, '5000', '-8.168097', '113.435187', 28, 28, 3, '2022-05-01'),
(26, 'supardi', 'Jl.Baidi', '086123876909', '1647482034.png', 7, '700', 300, '5000', '-8.170055', '113.423934', 28, 29, 0, '0000-00-00');

-- --------------------------------------------------------

--
-- Table structure for table `tb_limitpetani`
--

CREATE TABLE `tb_limitpetani` (
  `id_limitpetani` int(11) NOT NULL,
  `limitstok` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tb_limitpetani`
--

INSERT INTO `tb_limitpetani` (`id_limitpetani`, `limitstok`) VALUES
(1, 300);

-- --------------------------------------------------------

--
-- Table structure for table `tb_limitretail`
--

CREATE TABLE `tb_limitretail` (
  `id_limitretail` int(11) NOT NULL,
  `limitstok` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tb_limitretail`
--

INSERT INTO `tb_limitretail` (`id_limitretail`, `limitstok`) VALUES
(1, 100),
(2, 200),
(3, 300);
...
CREATE TABLE `tb_retail` (
  ...
  `id_limitretail` int(11) DEFAULT NULL,
  `harga_jual` varchar(55) DEFAULT NULL,
...
INSERT INTO `tb_retail` (`id_retail`, `nama_retail`, `lokasi_retail`, `no_hp`, `foto_retail`, `id_jeruk`, `stok`, `berat`, `id_limitretail`, `harga_jual`, `harga_beli`, `latitude`, `longitude`, `user_id`, `status_aktif`) VALUES
(2, 'retail 1', 'semboro lor', '082226151251', '1650442937.png', 14, 200, 1, 1, '5000', '4000', '-8.194334', '113.448250', 2, 2);
...
(40, 'a', '$2y$10$4rleOktO2TwknsscLQTBu.02ZEBX6/CkmjnPD0z1s8wL3OW3MRFCm', 'a', '1654951174.jpg', 'Retail'),
(41, 'a', '$2y$10$Y/qngILfDKTnIicKS6ptPOXf7c4X/8VvwVGivhu8/BpQjXHZz66Sq', 'a', '1654985257.png', 'Retail');
...
INSERT INTO `transaksi_retail` (`kode_transaksiretail`, `kode_keranjangretail`, `tanggal_beli`, `nama_retail`, `alamat_pengiriman`, `harga_jual`, `bukti_pembayaran`, `status_pesanan`, `id_retail`) VALUES
('1705221652782458', '1705221652782458', '2022-05-17', 'retail', 'semboro', '10000', 'bukti_1605221652667613.jpeg', 'y', 2),
('2205221653188934', '2205221653188934', '2022-05-22', 'retail', 'dasdasf', '1000', '20220522DABYMLWX.jpg', 't', 2),
('2305221653274812', '2305221653274812', '2022-05-23', 'retail', 'adad', '1000', '20220523DJQ1NBFG.jpg', 't', 2),
('2805221653726736', '2805221653726736', '2022-05-28', 'retail', 'ada', '2000', '20220528A2AIEEWM.png', 't', 2);
...
--
-- Indexes for table `tb_limitpetani`
--
ALTER TABLE `tb_limitpetani`
  ADD PRIMARY KEY (`id_limitpetani`);

--
-- Indexes for table `tb_limitretail`
--
ALTER TABLE `tb_limitretail`
  ADD PRIMARY KEY (`id_limitretail`);
...
--
-- AUTO_INCREMENT for table `tb_limitpetani`
--
ALTER TABLE `tb_limitpetani`
  MODIFY `id_limitpetani` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tb_limitretail`
--
ALTER TABLE `tb_limitretail`
  MODIFY `id_limitretail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tb_retail`
  MODIFY `id_retail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
